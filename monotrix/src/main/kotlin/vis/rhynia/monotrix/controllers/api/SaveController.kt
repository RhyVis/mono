...
import vis.rhynia.monotrix.components.FuncSave
import vis.rhynia.monotrix.elements.web.ApiResponse
import vis.rhynia.monotrix.elements.web.post.PostStrSave
...
class SaveController(
    ...
    @GetMapping("/save")
    fun getSave(): ApiResponse = ApiResponse(funcSave.queryStr(0))

    @PostMapping("/save")
    fun postSave(
        @RequestBody post: PostStrSave,
    ): ApiResponse = ApiResponse(funcSave.queryStr(post.id))
